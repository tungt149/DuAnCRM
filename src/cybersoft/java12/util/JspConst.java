package cybersoft.java12.util;

public class JspConst {
	// HOME
	public static final String HOME 	= "/WEB-INF/views/dashboard.jsp";
	...
	public static final String PROJECT_DETAIL = "/WEB-INF/views/project/project-detail.jsp";
